<section id="features" class="exclusive-section padding-bottom-2 padding-top oh">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-xl-6">
                <div class="section-header left-style">
                    <h5 class="cate">Lista de Caracteríticas</h5>
                    <h2 class="title">Mira lo que puedes hacer con la App</h2>
                    <p> Puedes cargar productos y compartir la tienda por redes sociales, inventario y pedidos</p>
                </div>
                <div class="row mb--20">
                    <div class="col-sm-6">

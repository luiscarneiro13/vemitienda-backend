                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input id="bpm" name="bpm" type="number" min="20" max="300"
                                value="{{ old('bpm', $metronome->bpm) }}" placeholder="120"
                    ...
                    <div class="col-md-3" style="margin-top:32px">
                        <button type="button" class="btn btn-sm btn-outline-primary"
                            onclick="var bpmVal = document.getElementById('bpm').value; if (!bpmVal) { toastr.warning('Ingresá un BPM para escuchar la vista previa'); } else { MetronomePlayer.load({id: {{ $metronome->id }}, title: document.getElementById('title').value || 'Vista previa', artist: document.getElementById('artist').value, bpm: bpmVal}); MetronomePlayer.play(); }">

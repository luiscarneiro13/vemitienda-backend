...
<head>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6LdrJwMqAAAAAKmUD7DJjnKNNJ5fN1g20du-3IrX"></script>
    <script>
        document.addEventListener('submit', function(e) {
            e.preventDefault();
            grecaptcha.ready(function() {
                grecaptcha.execute('6LdrJwMqAAAAAKmUD7DJjnKNNJ5fN1g20du-3IrX', {
                    action: 'submit'
                }).then(function(token) {

...
<body>
    ...
    <p>
        ...
        poder facilitar, agilizar y cumplir los compromisos establecidos entre Ve mi
        Tienda y el Usuario o el mantenimiento de la relación que se establezca en los
        formularios que este rellene, o para atender una solicitud o consulta del mismo.
        Principios aplicables al tratamiento de los datos personales
        Categorías de datos personales
        Las categorías de datos que se tratan en Ve mi Tienda son únicamente datos
        identificativos. En ningún caso, se tratan categorías especiales de datos personales.
        ...
        relacionados con el contenido del Sitio Web o aplicación, se le informará en caso
        de que la cumplimentación de alguno de ellos sea obligatoria debido a que los
        mismos sean imprescindibles para el correcto desarrollo de la operación realizada.
        Fines del tratamiento a que se destinan los datos personales
        Los datos personales son recabados y gestionados por Ve mi Tienda con la
        finalidad de poder facilitar, agilizar y cumplir los compromisos establecidos entre el
        Sitio Web / Aplicación móvil y el Usuario o el mantenimiento de la relación que se
        establezca en los formularios que este último rellene o para atender una solicitud o
        consulta.
        Igualmente, los datos podrán ser utilizados con una finalidad comercial de
        personalización, operativa y estadística, y actividades propias del objeto social
        de Ve mi Tienda, así como para la extracción, almacenamiento de datos y estudios
        de marketing para adecuar el Contenido ofertado al Usuario, así como mejorar la
        calidad, funcionamiento y navegación por el Sitio Web y aplicación.
        Destinatarios de los datos personales
        Los datos personales del Usuario no serán compartidos con terceros.
        Secreto y seguridad de los datos personales
        Ve mi Tienda se compromete a adoptar las medidas técnicas y organizativas
        necesarias, según el nivel de seguridad adecuado al riesgo de los datos recogidos,
        de forma que se garantice la seguridad de los datos de carácter personal y se evite
        ...
        los datos personales se transmiten de forma segura y confidencial, al ser la
        ...
        Correo electrónico: vemitienda@gmail.com
    </p>
    ...
    <p>
        ...
        así como que acepte el tratamiento de sus datos personales para que el
        Responsable del tratamiento pueda proceder al mismo en la forma, durante los
        plazos y para las finalidades indicadas. El uso del Sitio Web y/o la aplicación móvil
        implicará la aceptación de la Política de Privacidad del mismo.
        Ve mi Tienda se reserva el derecho a modificar su Política de Privacidad, de
        acuerdo a su propio criterio, o motivado por un cambio legislativo, jurisprudencial
        o doctrinal de Protección de Datos. Los cambios o actualizaciones de esta Política

<section class="banner-4 bg_img oh bottom_left"
    data-background="{{ asset('plantillas/mosto/images/banner/banner-bg-4.png') }}">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-xl-5">
                <div class="banner-nav-container bg_img bg_contain bottom_center"
                    data-background="{{ asset('plantillas/mosto/images/banner/banner-4.png') }}">
                    <div class="ban-nav">
                ...
                <div class="banner-odometer">
                    <div class="counter-item">
                        <div class="counter-thumb">
                            <img src="{{ asset('plantillas/mosto/images/icon/counter1.png') }}" alt="icon">
                        </div>
                    ...
                    <div class="counter-item">
                        <div class="counter-thumb">
                            <img src="{{ asset('plantillas/mosto/images/icon/counter2.png') }}" alt="icon">
                        </div>
                        <div class="counter-content">

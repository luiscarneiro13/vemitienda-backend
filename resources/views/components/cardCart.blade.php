<div class="flex justify-between py-4 border-b border-gray-100 relative w-full">
    <span class="text-gray-600 text-xs ml-3 underline cursor-pointer absolute left-0" style="top: 12px;">
        <div class="h-6 w-6 cursor-pointer">
            <svg class="mt-3" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
    ...
    <div class="w-9/12 lg:w-10/12 mt-3">
        ...
        <div class="flex items-end">
            <div class="flex">
                <div
                    class="flex justify-between control w-full border-solid border border-gray-200 rounded transition duration-500 ease-in-out">
                    <div class="control-action h-8 w-8 z-20">
                        <div class="items-center">
                            <svg viewBox="0 0 24 24" class="select-none icon-minus text-blue-500"
                                style="stroke-width: 2.5px;">
                                <path d="M19,13H5V11H19V13Z"></path>
                            </svg>
                        </div>
                    </div>
                    <div class="px-5 sm:px-10 h-8 select-none relative z-0 control-input">
                        <span class="font-semibold absolute text-sm"
                            style="left: 50%; top: 50%; transform: translate(-50%, -50%);">
                            {{ $product->quantity }}
                        </span>
                    </div>
                    <div class="control-action h-8 w-8 z-10 hover:bg-gray-100">
                        <div class="items-center">
                            <svg viewBox="0 0 24 24" class="select-none icon-minus is-green"
                                style="width: 100%; height: 100%; stroke-width: 2.5px;">

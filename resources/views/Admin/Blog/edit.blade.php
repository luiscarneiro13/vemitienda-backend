...
@section('content')
    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <div class="row">
                <div class="col-6">
                    <h5 class="text-default"><i class="fa fa-user-circle"></i> Actualizar Post</h5>
                </div>
            ...
            <form id="form" action="{{ route('blog.update', $blog->id) }}" method="POST">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <x-text name="name" columns="6" label="Título" required="true" :value="@$blog->name" />
                    ...
                    <div id="bodyEditor">{!! $blog->body !!}</div>
                </div>

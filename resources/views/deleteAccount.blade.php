            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2 class="text-center">Contáctanos para eliminar tu cuenta</h2>
                        <p>
                            Escríbenos un correo a:
                            <strong>info@vemitienda.com</strong> solicitando la eliminación de tu cuenta y con gusto te atenderemos.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">

...
<head>
  ...
  ================================================== -->
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('plantillas/small-apps/images/favicon.png') }}" />

    <!-- PLUGINS CSS STYLE -->
    <link rel="stylesheet" href="{{ asset('plantillas/small-apps/plugins/bootstrap/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{ asset('plantillas/small-apps/plugins/themify-icons/themify-icons.css')}}">
    <link rel="stylesheet" href="{{ asset('plantillas/small-apps/plugins/slick/slick.css')}}">
    <link rel="stylesheet" href="{{ asset('plantillas/small-apps/plugins/slick/slick-theme.css')}}">
    <link rel="stylesheet" href="{{ asset('plantillas/small-apps/plugins/fancybox/jquery.fancybox.min.css')}}">
    <link rel="stylesheet" href="{{ asset('plantillas/small-apps/plugins/aos/aos.css')}}">

    <!-- CUSTOM CSS -->
    <link href="{{ asset('plantillas/small-apps/css/style.css') }}" rel="stylesheet">
...
<body class="body-wrapper" data-spy="scroll" data-target=".privacy-nav">
    ...
    <nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
        <div class="container">
            <a class="navbar-brand" href="index.html"><img height="70px" src="{{ asset('img/logo2.png') }}"
                    alt="logo"></a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1 text-center text-md-left">
                    <h1 class="text-white font-weight-bold mb-4">Comparte tu Catálogo de Productos</h1>
                    <p class="text-white mb-5">Crea y comparte el catálogo de producto por Whatsapp, Facebook, Instagram, Correo electrónico, entre otros.</p>
                    <a href="FAQ.html" class="btn btn-primary btn-rounded-icon">
                        <i class="ti-cloud-down"></i>
                        Descargar
                    </a>
                    <a href="FAQ.html" class="btn btn-success btn-rounded-icon">
                        <i class="ti-email"></i>
                        Contacto
                    </a>
                </div>
                <div class="col-md-6 text-center order-1 order-md-2">
                    <img class="img-fluid" src="{{ asset('plantillas/small-apps/images/mobile.png') }}"
                        alt="screenshot">
                </div>
            </div>
        </div>
            ...
            <div class="rounded shadow p-5 bg-white">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
                        <i class="ti-package text-primary h1"></i>
                        <h3 class="mt-4 text-capitalize h5 ">Crea Productos</h3>
                        {{-- <p class="regular text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Aliquam
                            non, recusandae
                    ...
                    <div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
                        ...
                        <h3 class="mt-4 text-capitalize h5 ">Personaliza tu Catálogo</h3>
                        {{-- <p class="regular text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Aliquam
                            non, recusandae
                            tempore ipsam dignissimos molestias.</p> --}}
                    ...
                    <div class="col-lg-4 col-md-12 mt-5 mt-lg-0 text-center">
                        <i class="ti-sharethis text-primary h1"></i>
                        <h3 class="mt-4 text-capitalize h5 ">Comparte</h3>
                        {{-- <p class="regular text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Aliquam
                            non, recusandae
                            tempore ipsam dignissimos molestias.</p>
            ...
            <div class="row">
                <div class="col-lg-6 ml-auto justify-content-center">
                    ...
                    <div class="image-content" data-aos="fade-right">
                        <img class="img-fluid"
                            src="{{ asset('plantillas/small-apps/images/feature/feature-new-01.jpg') }}" alt="iphone">
                    </div>
                </div>
                <div class="col-lg-6 mr-auto align-self-center">
                    <div class="feature-content">
                        <!-- Feature Title -->
                        <h2>Incrementa tu productividad con Ve mi Tienda</h2>
                        <!-- Feature Description -->
                        <p class="desc">
                            Crea los Productos y podrás compartir fácil y rápido. Con Ve mi Tienda podrás
                            ahorrar tiempo en personalizar tu catálogo,
                            además puedes dejar de compartir uno o varios productos cuando desees y
                            no te des mala vida buscando la información de un producto o su imagen.<br />
                            Tendrás todo en un mismo lugar y de fácil acceso
                        </p>
                    </div>
                    <!-- Testimonial Quote -->
                    {{-- <div class="testimonial">
                        ...
                        <ul class="list-inline meta">
                            <li class="list-inline-item">
                                <img src="{{ asset('plantillas/small-apps/images/testimonial/feature-testimonial-thumb.jpg') }}"
                                    alt="">
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mr-auto justify-content-center">
                    ...
                    <div class="image-content" data-aos="fade-left">
                        <img class="img-fluid"
                            src="{{ asset('plantillas/small-apps/images/feature/feature-new-02.jpg') }}" alt="ipad">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-lg-6 align-self-center">
                    ...
                    <div class="service-thumb left" data-aos="fade-right">
                        <img class="img-fluid" src="{{ asset('plantillas/small-apps/images/feature/iphone-ipad.jpg') }}"
                            alt="iphone-ipad">
                    </div>
                </div>
...
=============================-->
    <footer>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12 m-md-auto align-self-center">
                        <div class="block">
                            <a href="index.html"><img src="{{ asset('plantillas/small-apps/images/logo-alt.png') }}"
                                    alt="footer-logo"></a>
                            <!-- Social Site Icons -->
        ...
        <div class="text-center bg-dark py-4">
            <small class="text-secondary">Copyright &copy; <script>
                ...
                </script>. Designed &amp; Developed by <a href="https://themefisher.com/">Themefisher</a></small
    ...
    <!-- JAVASCRIPTS -->
    <script src="{{ asset('plantillas/small-apps/plugins/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('plantillas/small-apps/plugins/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('plantillas/small-apps/plugins/slick/slick.min.js') }}"></script>
    <script src="{{ asset('plantillas/small-apps/plugins/fancybox/jquery.fancybox.min.js') }}"></script>
    <script src="{{ asset('plantillas/small-apps/plugins/syotimer/jquery.syotimer.min.js') }}"></script>
    <script src="{{ asset('plantillas/small-apps/plugins/aos/aos.js') }}"></script>
    <!-- google map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
    <script src="{{ asset('plantillas/small-apps/plugins/google-map/gmap.js') }}"></script>

    <script src="{{ asset('plantillas/small-apps/js/script.js') }}"></script>
</body>

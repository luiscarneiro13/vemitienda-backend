...
docker exec --tty=false "$APP_CONTAINER" chown -R www-data:www-data /var/www/public/images
docker exec --tty=false "$APP_CONTAINER" chmod -R 775 /var/www/public/images
docker exec --tty=false "$APP_CONTAINER" chmod -R 775 /var/www/public/thumbnails
